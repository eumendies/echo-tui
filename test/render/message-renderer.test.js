...
const { renderAssistantMessageLines, renderReasoningSummaryLines, renderShellBlock, renderUserBlock, renderUserMessageLines, renderErrorMessageLines } = require('../../src/render/blocks/message-renderer');
