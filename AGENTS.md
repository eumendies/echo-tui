...
- `src/commands/`: slash command handlers for `/help`, `/config`, `/model`, `/effort`, `/mode`, `/context`, `/usage`, `/clear`, `/compact`, `/diff`, `/undo`, `/resume`, `/mcp`, `/skills`, `/themes`, `/init`, `/review`, and direct skill invocation.
...
4. Slash commands and surfaces: `/help`, `/config`, `/model`, `/effort`, `/mode`, `/context`, `/usage`, `/clear`, `/compact`, `/diff`, `/undo`, `/resume`, `/mcp`, `/skills`, `/themes`, `/init`, `/review`, slash suggestions, Tab completion, and direct `/<skill-name>` invocation
