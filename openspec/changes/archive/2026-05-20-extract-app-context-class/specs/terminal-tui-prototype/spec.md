...
#### Scenario: 存在建议目录结构
- **WHEN** 实现完成
- **THEN** 项目 SHALL 包含 `bin/echo-tui.js`、`src/app/main.js`、`src/app/app-context.js`、`src/terminal/ansi.js`、`src/terminal/tty.js`、`src/input/event-types.js`、`src/input/key-parser.js`、`src/input/composer.js`、`src/render/layout.js`、`src/render/app-renderer.js`、`src/render/footer.js`、`src/render/blocks.js`、`src/agent/fake-agent.js`、`src/commands/`、`src/persistence/transcript-store.js`、`package.json`、`docs/README.md` 和 `docs/tui-architecture.md`
