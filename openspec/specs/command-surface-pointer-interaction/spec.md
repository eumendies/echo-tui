# command-surface-pointer-interaction Specification

## Purpose
TBD - created by archiving change expand-command-surface-pointer-interaction. Update Purpose after archive.
## Requirements
